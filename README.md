...
This is a convenience package that bundles the current release of **[LevelUP](https://github.com/rvagg/node-levelup)** and **[leveldown-basho](https://github.com/rvagg/leveldown-basho)** and exposes LevelUP on its export.
...
Level, including LevelUP & leveldown-basho, is only possible due to the excellent work of the following contributors:
